...
public class HashSetTxtbk {
	public static void main(String[] args) {
	    ...
	    System.out.println("Subjects only present in first stack : " + firstStackClone);
	    secondStackClone.removeAll(firstStack);
	    System.out.println("Subjects only present in second stack : " + secondStackClone);
